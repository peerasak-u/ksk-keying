...
Propose document/transaction segment boundaries over the client folder, resolve columbo's
...
- **in**: `ข้อมูลระบบ/_pages/inventory.yaml`, the client folder, `CLIENT.md`
- **out**:
